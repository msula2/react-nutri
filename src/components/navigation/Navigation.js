...
import recipes from '../../assets/imgs/recipes.png';
                ...
                <ul className="f5 fw6 ttu tracked list mb0 mt0">
                    <div className="flex items-center justify-between">
                            ...
                            <div className="flex justify-end">
                                ...
                                <div style={{float: "right"}} className={`flex items-center bl pr3 ${this.state.active ? "bg-black-90" : "bg-white-90"}`}>
                                    <li className="dib mr3 pa3">
                                        <Link className={this.state.active ? "white" : "black"} to="/recipes" onClick={this.tabActive}>Recipes</Link>
                                    </li>
                                    <img src={recipes} className="dib mw2"></img>
                                </div>
                            </div>
