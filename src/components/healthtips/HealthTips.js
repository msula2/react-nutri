          ...
          (
            <>
              ...
              <div className='vw-100 vh-100 d-flex flex-column justify-center items-center' style={{display: loading? 'none' : ''}}>
                ...
                <div className="health-tips-container vw-100 vh-100 d-flex flex-column justify-center items-center">
                  <section className="tips-section w-100 d-flex flex-column justify-center items-center">
